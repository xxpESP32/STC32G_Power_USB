...
void LCD_ShowFloatNum1(u16 x,u16 y,float num,u8 len,u16 fc,u16 bc,u8 sizey);//显示三位小数变量
void LCD_ShowFloatNum2(u16 x,u16 y,float num,u8 len,u16 fc,u16 bc,u8 sizey);//显示两位小数变量
void LCD_ShowFloatNum(u16 x,u16 y,float num,u8 len,u16 fc,u16 bc,u8 sizey);//显示一位小数
void LCD_ShowFloatNum5(u16 x,u16 y,float num,u8 len,u16 fc,u16 bc,u8 sizey);
void LCD_ShowPicture(u16 x,u16 y,u16 length,u16 width,const u8 pic[]);//显示图片
void Progress_bar_Write(	u16 x_s,  
													u16 y_s,
													u16 x_e,
													u16 y_e,
													u16 per_color,
...
#define PINK             0xF81F
#define PINK_RED         0xF8CC
#define RED_NOW          0xF87F 
#define GREEN_NOW            0xeeFF
#endif
